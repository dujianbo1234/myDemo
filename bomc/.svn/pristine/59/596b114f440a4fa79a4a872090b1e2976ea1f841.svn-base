<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm ideaSummary">
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          switch (ruleForm.checkResult) {
            case "通过":
              data.variables.push({ key: "pass", value: "true" });
              break;
            default:
              data.variables.push({ key: "pass", value: "false" });
              break;
          }
