<template>
    <div class="container">
        ...
        <el-row>
            <el-col>
                 <el-card>
                <el-table v-loading="tableLoading" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" :default-sort="{prop: 'userId', order: 'ascending'}">
...
<script>
import * as service from '@/modules/ops/api/ops/deployUpdate/deployUpdateJournal.js'
