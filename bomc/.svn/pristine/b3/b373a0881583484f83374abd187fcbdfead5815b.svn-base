  ...
  <div class="oms-diy-elementui eventContainer problemContainer">
    ...
    >
      ...
      <div class="basicInfoArea">
        ...
        <el-row>
          <el-col :span="16">
            <el-form-item label="问题描述：" prop class="problemDir textarea investigation">
          ...
          <el-col :span="8">
            ...
            <el-form-item label="问题期望解决时间" prop>
              <el-date-picker
                class="oms-input"
            ...
            <el-form-item label="实际诊断开始时间" prop>
              <el-date-picker
                class="oms-input"
            ...
            <el-form-item label="实际诊断结束时间" prop>
              <el-date-picker
                class="oms-input"
            ...
            <el-form-item label="回顾结果：" prop>
              <el-select v-model="ruleForm.reviewResult" class="oms-select" :disabled="true">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="是否有效问题：" prop>
          ...
          <el-col :span="8">
            <el-form-item label="重复问题标记：" prop>
          ...
          <el-col :span="8">
            <el-form-item label="问题结束代码：" prop>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="关联事件单号：" prop>
              <el-input class="oms-input" v-model="ruleForm.relatedEventId" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="关联变更单号：" prop>
              <el-input class="oms-input" v-model="ruleForm.relatedAlterId" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="关联知识单号：" prop="relatedKnowledgeId">
              <el-input class="oms-input" v-model="ruleForm.relatedKnowledgeId"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </div>
  ...
  methods: {
    ...
    queryData() {
      ...
      service.queryData(params).then(res => {
        ...
        this.ruleForm.status = "问题关闭";
        if (this.ruleForm.isEffective === null) {
          this.ruleForm.isEffective = "";
        } else if (this.ruleForm.isEffective === 0) {
          this.ruleForm.completeCode = "取消";
        }
          ...
          this.$confirm("是否确认关闭?", "提示", {
            ...
            .then(async () => {
              ...
              if (this.fileList.length > 0) {
                await this.uploadAttachment(); // 上传附件
              }
              let params = {
                procInstId: this.procInstId
              };
