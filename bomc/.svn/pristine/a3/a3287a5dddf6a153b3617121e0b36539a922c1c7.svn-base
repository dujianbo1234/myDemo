<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm urgMakePlan">
  ...
  methods: {
    ...
    queryEventManager() {
      ...
      service.queryEventManager(params).then(res => {
        this.companyUserId = res.result[0].userId;
      });
    },
    querySystemType() {
      //查询系统类型信息
