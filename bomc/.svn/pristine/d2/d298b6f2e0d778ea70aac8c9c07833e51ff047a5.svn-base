<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm approve">
          ...
          switch (ruleForm.riskLevel) {
            case "重大":
              data.variables.push(
                ...
                { key: "riskLevelIsHigh", value: "true" }
              );
              break;
            case "高":
              data.variables.push(
              ...
              break;
            default:
              data.variables.push({ key: "riskLevelIsHigh", value: "false" });
              break;
          }
