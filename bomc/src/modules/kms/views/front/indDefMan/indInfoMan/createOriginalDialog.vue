  ...
  methods: {
    ...
    next(form, formY, addForm) {
      ...
      if (this.updateType === "update") {
        ...
        //2-1---------------------------------------------
        if (this.form.calcType == 0 && this.active == 1 &&this.formY.category==0) {
          this.mystatu1 = false;
          this.mystatu2 = false;
          this.stepW = true;
          this.keepBt = true;
       ...
       if (this.form.calcType == 0 && this.active == 1 &&this.formY.category==1) {
          this.mystatu1 = false;
          this.mystatu2 = true;
          this.stepW = true;
          this.keepBt = false;
        ...
        if (this.form.calcType == 1 && this.active == 1 &&this.addForm.category==0) {
          this.mystatu1 = false;
          this.mystatu2 = false;
          this.keepBt = true;
          this.stepW = true;
        ...
        if (this.form.calcType == 1 && this.active == 1 &&this.addForm.category==1) {
          this.mystatu1 = false;
          this.mystatu2 = true;
          this.keepBt = false;
          this.stepW = true;
    ...
    postMetrics(triggerObj) {
      ...
      // 特殊告警校验----------------------原始和聚合同一判断
      var a="",b="",c="",d="",e="",f=""
      this.triggerObj.thresholds.forEach((item,index)=> {
             e=item.from
             f=item.to
          });
      this.excludeStrategy.forEach((item,index)=> {
        ...
        if(a==""&&b==""&&c==""&&d==""&&e==""&&f==""&&this.excludeStrategyCount>0){
            this.$refs.triggerObj.validate(valid => {
                   this.disabled = false;
                       this.$message({
                        showClose: true,
            ...
            }else if(a==""&&this.excludeStrategyCount>0){
              this.$refs.triggerObj.validate(valid => {
                  this.disabled = false;
                    this.$message({
                            showClose: true,
                ...
                }else if(b==""&&this.excludeStrategyCount>0){
                this.$refs.triggerObj.validate(valid => {
                  this.disabled = false;
                    this.$message({
                            showClose: true,
                ...
                }else if(c==""&&this.excludeStrategyCount>0){
                    this.$refs.triggerObj.validate(valid => {
                      this.disabled = false;
                        this.$message({
                                showClose: true,
                ...
                }else if(d==""&&this.excludeStrategyCount>0){
                    this.$refs.triggerObj.validate(valid => {
                      this.disabled = false;
                        this.$message({
                                showClose: true,
                ...
                }else if(e==""&&this.excludeStrategyCount>0){
                    this.$refs.triggerObj.validate(valid => {
                      this.disabled = false;
                        this.$message({
                                showClose: true,
                ...
                } else if(f==""&&this.excludeStrategyCount>0){
                    this.$refs.triggerObj.validate(valid => {
                      this.disabled = false;
                        this.$message({
                                showClose: true,
     ...
     // ===================================原始
    if(a!==""&&b!==""&&c!==""&&d!==""&&e!==""&&f!==""&&this.excludeStrategyCount>0&&this.formY.category == 1){
      this.$refs.triggerObj.validate(valid => {
            if (this.flag) {
              return false;
            } else {
      ...
      // ===================================聚合
   if(a!==""&&b!==""&&c!==""&&d!==""&&e!==""&&f!==""&&this.excludeStrategyCount>0&&this.addForm.category == 1){
      this.$refs.triggerObj.validate(valid => {
            if (this.flag) {
              return false;
            } else {
        ...
        // 聚合告警
    if (this.form.calcType == 1 && this.addForm.category == 1&&this.excludeStrategyCount==0) {
        this.disabled = true;
        this.$refs.triggerObj.validate(valid => {
          if (valid) {
            if (this.flag) {
