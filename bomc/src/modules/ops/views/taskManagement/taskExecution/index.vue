				...
				<el-card>
					<el-form :inline="true" label-position="right" label-width="70px" size="small" :model="formCascader" :rules="formCascaderRules" ref="formCascader">
						<el-form-item label="任务类型"  prop="taskType"> 
							<el-select v-model="formCascader.taskType" placeholder="请选择任务类型">
						...
						<el-form-item label="任务名称" prop="name">
							...
							<div ref="schItemShow2" class="schItemShow">
								...
								<!-- <el-form-item label="平台类型"  prop="platformType"> 
									<el-select v-model="formCascader.platformType" placeholder="请选择平台类型" >
      		...
      		<div class="RightRow">
        		<el-card>
					...
					<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" @selection-change="handleSelectionChange" :header-cell-style="headStyle">
						...
						<el-table-column show-overflow-tooltip prop="modelType" label='任务类型' min-width="100" >
						</el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="plan" label='部署进度' min-width="100" align="left">
...
<script>
	import * as service from '@/modules/ops/api/ops/excuteApi/excuteApi.js'
...
　　　　 },
		...
		methods: {
			...
			// websocket
			initWebSocket(ids){ //初始化weosocket
				const wsuri = 'ws://172.27.35.19:8082/ops/api/v1/websocket/'+ ids +'';        
