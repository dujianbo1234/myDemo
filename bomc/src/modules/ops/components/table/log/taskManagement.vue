			...
			<div class="RightRow">
				<el-card>
					<el-form :inline="true" label-position="right" label-width="70px" size="small" :model="formCascader" :rules="formCascaderRules" ref="formCascader">
                        <el-form-item label="任务类型" prop="module">
                            <el-select v-model="formCascader.module" placeholder="请选择任务类型"  >
                                <el-option
      		...
      		<div class="RightRow">
        		<el-card>
					<div class="buttonItem">
						<el-button size="small" plain class="opt_btn del_btn" @click="exportLogo()">导出</el-button>
					</div>
					<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" @selection-change="handleSelectionChange" :header-cell-style="headStyle">
                        ...
                        <el-table-column show-overflow-tooltip prop="createTime" label="任务类型" :formatter="formatmodel" />
...
export default {
    ...
    methods: {
        ...
        queryData() {
            ...
            const params = {
                module: this.formCascader.module,
            ...
            service.taskLogoQuery(params).then(res => {
                console.log(res)
                if(res.code == 200) {
