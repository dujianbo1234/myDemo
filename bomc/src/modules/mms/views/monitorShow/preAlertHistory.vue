  ...
  <div class="monitor-container">
    ...
    <el-card class="cardM">
      <el-row class="btnInfo" justify="end" type="flex">
        <el-col :span="6">
          <el-button type="primary" @click="alertHistoryExportCheck">导出</el-button>
          <el-button type="primary" @click="alertHistoryExportAll">导出所有</el-button>
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="name" label="告警名称" width="100"></el-table-column>
          <el-table-column prop="code" label="告警编码" width="80"></el-table-column>
          <el-table-column label="告警ID" width="220">
            <template slot-scope="scope">{{ scope.row.id }}</template>
          </el-table-column>
          <el-table-column v-if="alertHistoryStateShow" label="告警状态" width="80">
            <template slot-scope="scope">{{ scope.row.status | leavelState}}</template>
          </el-table-column>
          <el-table-column v-if="alertHistoryobjShow" prop="resourceObject" label="对象" width="110"></el-table-column>
          <el-table-column
          ...
          ></el-table-column>
          <el-table-column v-if="alertHistoryLastTimeShow" label="最后发生时间">
            <template slot-scope="scope">{{scope.row.lastAlertTime | strToDataFromat}}</template>
          </el-table-column>
          <el-table-column v-if="alertHistoryLeaveShow" label="当前告警级别" width="110">
            <template slot-scope="scope">
              <el-button type="primary" v-if="scope.row.level =='0'">一般告警</el-button>
              <el-button type="warning" v-if="scope.row.level =='1'">主要告警</el-button>
              <el-button type="danger" v-if="scope.row.level =='2'">严重告警</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
