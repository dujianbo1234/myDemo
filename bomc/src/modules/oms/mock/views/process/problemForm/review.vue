  ...
  <div class="oms-diy-elementui eventContainer problemContainer">
    ...
    >
      ...
      <div class="basicInfoArea">
        ...
        <el-row>
          ...
          <el-col :span="8">
            ...
            <el-form-item label="回顾结果：" prop="reviewResult">
              <el-select v-model="ruleForm.reviewResult" class="oms-select">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="问题结束代码：" prop="completeCode">
              <el-select class="oms-select" v-model="ruleForm.completeCode">
      ...
      <el-row class="operation">
        <el-button type="info">转知识管理流程</el-button>
            ...
            variables: [
              {
                key: "pass",
                type: "string",
                value: ruleForm.reviewResult === 1 ? true : false
              }
            ]
          };
