  ...
  <div class="oms-diy-elementui eventContainer">
    ...
    >
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="是否解决：">
              <el-select v-model="ruleForm.checkResult" class="oms-select" disabled>
      ...
      <el-row class="operation">
        <el-button type="info">转问题管理流程</el-button>
  ...
  methods: {
    ...
    queryData() {
      ...
      service.queryData(params).then(res => {
        ...
        this.ruleForm.eventStatus = "处理总结";
