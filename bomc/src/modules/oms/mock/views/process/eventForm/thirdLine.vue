    ...
    >
      ...
      <el-tabs type="border-card" class="tabsArea">
        <el-tab-pane label="解决方案">
          <el-row>
            <el-col :span="24">
              <el-form-item class="dealSuggestion" label="解决方案：" prop="fullMsg">
  ...
  methods: {
    ...
    queryData() {
      ...
      service.queryData(params).then(res => {
        ...
        this.ruleForm.eventStatus = "三线处理";
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          delete dataString.form.checkResult;
