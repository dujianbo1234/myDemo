<template>
  <div class="oms-diy-elementui eventContainer classifyAndDeel">
    ...
    >
      ...
      <div class="basicInfoArea">
        ...
        <el-row>
          <el-col :span="16">
            <el-form-item class="eventDicr" label="事件描述：" prop>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="地点：" prop>
              <el-input class="oms-input" v-model="ruleForm.location" :disabled="false"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <!-- <el-col :span="8">
            <el-form-item
              label="事件涉及组："
              :prop="ruleForm.checkResult==='0'? 'relatedOrg':''"
            >
            
              <el-cascader
                :options="eventInGroupList"
                v-model="ruleForm.relatedOrg"
                :disabled="ruleForm.checkResult!=='0'"
              >
              </el-cascader>
            </el-form-item>
          </el-col>-->
      ...
      <div class="dealStepsArea">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="事件涉及组：" prop="relatedOrg" v-if="ruleForm.checkResult==='0'">
              <el-cascader :options="eventInGroupList" v-model="ruleForm.relatedOrg"></el-cascader>
            </el-form-item>
            <!-- <el-form-item
              label="下一环节解决人"
              prop="nextNodeDealMan"
            >
              <el-cascader
...
export default {
  ...
  watch: {
    ...
    "ruleForm.relatedOrg": function(val, oldVal) {
      if (val.length > 0) {
  ...
  methods: {
    ...
    queryData() {
      ...
      service.queryData(params).then(res => {
        ...
        this.ruleForm.eventStatus = "事件分类与处理";
    ...
    saveAsDraft(formName) {
      ...
      service
        .updateFormData(this.procInstId, data)
        .then(res => {
          loading.close();
          this.isSaved = true;
          this.$message({
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if (this.ruleForm.checkResult == 0) {
            //未解决
            data.variables = [
              { key: "solve", value: "false" },
              { key: "userIdSecond", value: ruleForm.eventManager }
            ];
          } else {
            //已解决
            data.variables = [{ key: "solve", value: "true" }];
          }
