        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="重复问题标记：" prop="isRepeating">
              <el-select class="oms-select" v-model="ruleForm.isRepeating">
  ...
  methods: {
    ...
    validatePass(rule, value, callback) {
      if (
        ...
        // if (
        //   rule.fullField === "diagnosisStartTime"
        // ) {
        //   if(
        //     this.ruleForm.diagnosisEndTime&&(new Date(value).getTime() > new Date(this.ruleForm.diagnosisEndTime).getTime())
        //     ){
        //     callback(new Error(" "));
        //     this.$notify({
        //       title: "提示",
        //       message: "实际诊断开始时间不能大于实际结束诊断时间"
        //     });
        //   }else{
        //     callback();
        //   }
        // }else if (
        //   rule.fullField === "diagnosisEndTime"
        // ) {
        //   if(new Date(this.ruleForm.diagnosisStartTime).getTime() > Date.now() ) {
        //     callback(new Error(" "));
        //       this.$notify({
        //         title: "提示",
        //         message: "实际结束诊断时间不能超过当前时间"
        //       });
        //   }else if(new Date(value).getTime() < new Date(this.ruleForm.diagnosisStartTime).getTime()){
        //     callback(new Error(" "));
        //     this.$notify({
        //       title: "提示",
        //       message: "实际结束诊断时间不能小于实际诊断开始时间"
        //     });
        //   }else{
        //     callback();
        //   }
    ...
    saveAsDraft(formName) {
      ...
      ruleForm.nextNodeDealMan = this.userId;
      ...
      const dataComments = {
        ...
        isDraft: 1,
        assignee: ruleForm.nextNodeDealMan
      };
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          let data = {
            ...
            // variables: [
            //   {
            //     key: "handlerUserIdSecond",
            //     type: "string",
            //     value: ruleForm.nextNodeDealMan
            //   }
            // ]
          };
