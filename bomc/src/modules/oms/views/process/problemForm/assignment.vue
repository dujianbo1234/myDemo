    ...
    >
      ...
      <div class="basicInfoArea">
        ...
        <el-row>
          ...
          <el-col :span="8">
            ...
            <el-form-item label="是否有效问题：" prop="isEffective">
              <el-select v-model="ruleForm.isEffective" class="oms-select">
        ...
        <el-row>
          ...
          <!-- <el-col :span="8">
            <el-form-item class="pointer" label="问题类别信息：" prop="questionCategory">
              <el-cascader
      ...
      <div class="dealStepsArea">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="下一环节处理人" prop="nextNodeDealMan" v-if="ruleForm.isEffective!==0">
...
export default {
  ...
  methods: {
    ...
    changeTab(val) {
      ...
      if (this.tabActive === "form" && this.ruleForm.title === "") {
        // 表单信息如果无数据才开始查，无数据就不查，避免多次查询
        this.queryData();
      }
    },
    enlarge() {
            ...
            variables: [
              {
                key: "effective",
                type: "string",
                value: this.ruleForm.isEffective === 1 ? "true" : "false"
              }
            ]
          };
          if (this.ruleForm.isEffective === 1) {
            //问题有效
            data.variables.push({
              key: "handlerUserId",
              type: "string",
              value: this.ruleForm.nextNodeDealMan
            });
          } else {
          }
...
<style lang="scss">
.problemContainer .problemDir .el-textarea__inner {
  height: 165px;
}
</style>