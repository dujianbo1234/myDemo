<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm urgTaskImplement">
    ...
    >
      ...
      <div class="dealStepsArea">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="实施结果" prop="checkResult">
              <el-select
                class="oms-select"
              ...
              >
                ...
                <el-option label="不成功" value="不成功"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
