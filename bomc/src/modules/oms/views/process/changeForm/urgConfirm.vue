<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm urgConfirm">
    ...
    >
      ...
      <div class="basicInfoArea">
        ...
        <el-row>
          <el-col :span="16">
            <el-form-item label="变更描述" class="changeFromDescr textarea" prop>
              <el-input
                class="oms-input"
                type="textarea"
  ...
  methods: {
    ...
    queryEventManager() {
      ...
      service.queryEventManager(params).then(res => {
        this.committeeUserId = res.result[0].userId;
      });
    },
    querySystemType() {
      //查询系统类型信息
