<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm dispatchTask">
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          switch (ruleForm.isUpdateConfiguration) {
            case 1:
              data.variables.push(
                { key: "isConfigurationTypeChange", value: "true" },
                { key: "handleUserId", value: this.ruleForm.nextLinkDealUserId }
              );
              break;
            case 0:
              data.variables.push({
                key: "isConfigurationTypeChange",
                value: "false"
              });
              break;
            default:
