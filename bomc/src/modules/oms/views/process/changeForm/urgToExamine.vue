<template>
  <div class="oms-diy-elementui eventContainer problemContainer changeForm urgToExamine">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="变更结束代码" prop="alterEndCode">
              <el-select class="oms-select" v-model="ruleForm.alterEndCode" placeholder>
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="回顾代码" prop="reviewCode">
              <el-select class="oms-select" v-model="ruleForm.reviewCode" placeholder>
                <el-option
...
export default {
  ...
  methods: {
    ...
    queryParams() {
      ...
      const params = {
        name:
          "alter_resource,alter_type,risk_level,alter_category,alter_end_code,review_code"
      };
      service.queryParams(params).then(res => {
        const data = res.result;
        if (data && data.length) {
          name: "alter_resource,alter_type,risk_level,alter_category,alter_end_code,review_code";
          const obj = {};
          data.forEach(item => {
